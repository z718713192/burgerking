...
function HS_calender(){
    ...
    style +=".calender { width:170px; height:auto; font-size:12px;margin-right:14px; background: no-repeat right center #fff; border:1px solid #397EAE; padding:1px;z-index:19999}";
