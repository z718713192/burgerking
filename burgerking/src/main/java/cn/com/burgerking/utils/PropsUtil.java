...
public class PropsUtil {
    ...
    public static void main(String[] args) {
    	//初始化属性文件
		PropsUtil propsUtil = new PropsUtil("html-template");
		//获得Map集合
		Map<String, String> map = propsUtil.loadPropsToMap("html-template");
		//根据key获得某个值
		String string = propsUtil.getString("article.content.after");
		System.out.println(string);
		System.out.println(map.get("article.content.after"));
	}
}
